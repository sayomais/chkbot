...
from all.functions.func_avs.func_draken import *
...
async def ausexcmds(_, message):
    ...
    if usuario is not None and usuario.get("role") == "Owner":
        ...
        if not comandos_habilitados.get('dk', {}).get('enabled', False):
            reason = comandos_habilitados.get(
                'dk', {}).get('reason', "Unknown")
            date = comandos_habilitados.get('dk', {}).get('date', "Unknown")
            _textoff = f"""<b>━━━━━━━━「ELAINA」━━━━━━━━
<i>Info</i> ➣ <i>The {cmdgate} command is disabled</i> ❗ 
━━━━━━━━「ELAINA」━━━━━━━━</b>"""
...
━━━━━━━━「ELAINA」━━━━━━━━</b>"""
    ...
    Status = await draken(cc, mes, ano, cvv)
