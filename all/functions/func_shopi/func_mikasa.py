...
async def auto_sho_async(cc, mes, ano, cvv):
    ...
    async with aiohttp.ClientSession(connector=conn) as session:
        ...
        req1 = await session.post(url=f'https://www.eoproducts.com/cart/add', data=payload_1, timeout=aiohttp.ClientTimeout(total=5))

        req3 = await session.get(url=f"https://www.eoproducts.com/checkout", timeout=aiohttp.ClientTimeout(total=5))
        ...
        payload_4 = {
            ...
            "payment_session_scope": "eoproducts.com"
        }
