...
async def auto_sho_async(cc, mes, ano, cvv):
    ...
    async with aiohttp.ClientSession(connector=conn) as session:
        ...
        req1 = await session.post(url=f'https://www.toadandco.com/cart/add.js', data=payload_1, timeout=aiohttp.ClientTimeout(total=5))

        req3 = await session.get(url=f"https://toadandco.com/checkout", timeout=aiohttp.ClientTimeout(total=5))
